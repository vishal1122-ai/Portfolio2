  ...
  const services = [
    {
      icon: 'fas fa-palette',
      title: 'Web Design',
      description: 'Creating visually stunning and user-friendly interface designs that captivate and engage users.'
    },
    {
      icon: 'fas fa-code',
      title: 'Web Development',
      description: 'Building responsive, performant web applications using modern frameworks and technologies.'
    },
    {
      icon: 'fas fa-magic',
      title: 'Interactive Prototypes',
      description: 'Developing interactive prototypes with advanced animations and micro-interactions.'
    },
    {
      icon: 'fas fa-cube',
      title: '3D Web Experiences',
      description: 'Creating immersive 3D web experiences using Three.js and WebGL technologies.'
    }
  ];
