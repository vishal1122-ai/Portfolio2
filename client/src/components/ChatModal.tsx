...
export default function ChatModal() {
  ...
  const handleOptionClick = (option: string) => {
    ...
    alert(`Thanks for your interest! Please email me directly for now: ${option}`);
    setIsOpen(false);
  };
        ...
        <div className="fixed bottom-24 right-8 w-80 bg-white dark:bg-dark-card rounded-2xl shadow-2xl z-50 overflow-hidden">
          <div className="bg-gradient-to-r from-electric to-neon p-4">
            <div className="flex items-center justify-between">
              <h3 className="text-white font-semibold">Chat with Vishal</h3>
              <button 
          ...
          <div className="p-4">
            <div className="space-y-3 mb-4">
              <div className="bg-gray-100 dark:bg-dark-border p-3 rounded-lg">
                <p className="text-sm">Hi! I'm Vishal. Thanks for checking out my portfolio! 👋</p>
              </div>
              <div className="bg-gray-100 dark:bg-dark-border p-3 rounded-lg">
            ...
            <div className="space-y-2">
              {chatOptions.map((option, index) => (
                <button 
                  ...
                  className="w-full text-left p-3 rounded-lg bg-gray-50 dark:bg-dark-border hover:bg-electric hover:text-white transition-colors text-sm"
                >
                  {option}
                </button>
              ))}
