  ...
  const projects: Project[] = [
    {
      ...
      description: "A modern e-commerce platform with React, Node.js, and advanced animations. Features include real-time cart updates, payment integration, and responsive design.",
    ...
    },
    {
      ...
      description: "An immersive 3D portfolio website built with Three.js and React. Features interactive 3D models, particle systems, and smooth scroll animations.",
      image: "https://images.unsplash.com/photo-1618477247222-acbdb0e159b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
    ...
    },
    {
      ...
      description: "A high-converting SaaS landing page with advanced animations, micro-interactions, and optimized conversion funnels.",
    ...
    },
    {
      ...
      description: "A data visualization dashboard with real-time charts, interactive elements, and responsive design for analytics platforms.",
    ...
    },
    {
      ...
      description: "An interactive particle system built with WebGL and Three.js, featuring physics simulation and real-time user interaction.",
    ...
    },
    {
      ...
      description: "A professional corporate website with modern design, smooth animations, and optimized performance for business clients.",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            A showcase of selected projects demonstrating expertise in modern web technologies and creative design.
          </p>
        </div>
